...
const LIQUIDATOR_ADDRESS = "0x03d4C4b1B115c068Ef864De2e21E724a758892A2";
...
function _updateUsdgAmount(timestamp: BigInt, period: string, token: Address, usdgAmount: BigInt): void {
  let entity = _getOrCreateTokenStat(timestamp, period, token);
